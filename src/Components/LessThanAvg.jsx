...
const LessThanAvg = () => {
  const [lessthanavg, setLessthanavg] = useState([]);
  const [error, setError] = useState("");

  const url = "http://localhost:3001/lessthanavg";
  ...
  return (
    <div>
      ...
      <div className="">
        <p className="text-4xl p-7">Meals calories less than average</p>
